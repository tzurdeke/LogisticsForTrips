...
## 📑 תוכן עניינים
1. [מבוא](#-מבוא)  
2. [מסכי המערכת](#-מסכי-המערכת-ai-studio)  
3. [תרשים ERD](#-תרשים-erd)  
4. [תרשים DSD](#-תרשים-dsd)  
5. [SQL Scripts](#-sql-scripts)  
6. [יצירת נתונים](#-יצירת-נתונים-csv--python)  
...
להלן המסכים שנוצרו באמצעות Google AI Studio:
...
- **סקריפט יצירת טבלאות**  
  [צפייה ב-createTables.sql](./createTables.sql)

- **סקריפט הכנסת נתונים**  
  [צפייה ב-insertTables.sql](./insertTables.sql)

- **סקריפט מחיקת טבלאות**  
  [צפייה ב-dropTables.sql](./dropTables.sql)

- **סקריפט שליפת כל הנתונים**  
  [צפייה ב-selectAll.sql](./selectAll.sql)
